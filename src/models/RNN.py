...
def RNN1(x_train, y_train, x_test, y_test):
    model = Sequential()
    model.add(SimpleRNN(180, activation='tanh', input_shape=(24, x_train.shape[2])))
    model.add(Dense(72))
...
if __name__ == '__main__':
    ...
    features = ['pm10','no2','ttt','td','pppp','ff','sin_dd','cos_dd','sin_hour','cos_hour','sin_weekday','cos_weekday','sin_month','cos_month']
    ...
    model = RNN1(x_train,y_train, x_test, y_test)
